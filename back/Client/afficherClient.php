          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="CompagnieAérienne">
              <ul class="nav flex-column sub-menu">
				...
				<li class="nav-item">
                  <a class="nav-link" href="../Client/modifierClient.html">Modifier</a>
                </li>
				<li class="nav-item">
                  <a class="nav-link" href="../Client/modifierClient.html">Supprimer</a>
                </li>
			   </ul>
            </div>
          </li> 
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Compagnie Aérienne</h4>
