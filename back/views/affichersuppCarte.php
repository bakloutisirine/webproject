        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../views/statistique.php">
              ...
              <span class="menu-title" href="">Tableau de bord </span>
            </a>
          </li>
              ...
              <div class="card">
                ...
                <form class="form-sample">
				  <table class="table table-hover table-striped table-bordered" >
					<tr>
					<td  style="color:#5983e8;font-weight:bold">Id Carte</td>
          <td  style="color:#5983e8;font-weight:bold">Id Client</td>
					<td  style="color:#5983e8;font-weight:bold">Nombre de points</td>
          <td  style="color:#5983e8;font-weight:bold">Date d'expiration</td>
					</tr>
					<?PHP
					foreach($listeCarte as $row){
						?>
						<tr>
						<td><?PHP echo "C_".$row['idCarte']; ?></td>
            <td><?PHP echo "Cl_".$row['idC']; ?></td>
            ...
            <a href=supprimerCarte.php?id=<?=$row['idCarte'];?> > supprimer </a>
						</td>
						<!--<td><a href="modifierClient.php?email=<?PHP echo $row['idCarte']; ?>">
						Modifier</a></td>
						-->
					    </tr>
						<?PHP
