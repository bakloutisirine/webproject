...
$listeClient=$Client1C->rechercherClient($search_value);
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                <form method="get" action="rechercheaffichersupp.php" >
                  <table style="center">
                    <tr>
          ...
          <td  style="color:#5983e8;font-weight:bold">ID Client</td>
            ...
            <td><?PHP echo "Cl_".$row['idClient']; ?></td>
						...
						<td> <!--<form method="GET" action="supprimerClient.php">
						<input type="submit" name="supprimer" value="supprimer">
						<input type="hidden" value="<?PHP echo $row['idClient']; ?>" name="idClient">
						</form>-->
            <a href=supprimerClient.php?id=<?=$row['idClient'];?>>supprimer </a>
						</td>
						<!--<td><a href="modifierClient.php?email=<?PHP echo $row['idClient']; ?>">
						Modifier</a></td>
						-->
					    </tr>
						<?PHP
