    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../views/clientchart.php">
              <i class="menu-icon mdi mdi-television"></i>
              <span class="menu-title" href="../views/clientchart.php">Tableau de bord </span>
            </a>
          </li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Ajouter une carte de fidélité</h4>	
      <form name="f" method="POST" action="ajoutCarte.php">
        <br>
        <fieldset>
          <br>  
          <input type="number" class ="nbPoint" id="nbPoint" name="nbPoint" placeholder="Nombre de points" required /> 
          <br><br>
          <input type="date" class="dateExpiration" id="dateExpiration" name="dateExpiration" placeholder="dateExpiration" required/>
          <br><br><br>
