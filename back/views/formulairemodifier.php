    ...
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
        ...
        <div class="content-wrapper">
		  ...
		  <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Modifier les coordonnés de votre client</h4>	
<form class="f" method="post">
<table>
  <tr>
    <td><label >Nom          </label></td>
    <td><input type="text"  class ="nom" id="nom"name="nom" value="<?=  $nom;?>" required></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="email" class="mail" name="email" id="email" value="<?=  $email;?>"></td>
  </div>
  <br>
  <tr>
    <td><label >Pays</label></td>
    <td><select class ="P" id="pays" name="pays" required >
            <option><?= $pays;?></option>
  ...
  <tr>
    ...
    <td><input type="text" class="numero" id="numero" name="numero" value="<?=  $numero;?>"required pattern="[0-9]{8}" title="Le numero contient huit chiffres."></td>
  </tr> 
  </table>
